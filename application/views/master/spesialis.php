 ...
 <div class="row">
        <div class="col-xs-12">
          <div class="box">
           ...
           <h3>
             &nbsp;<i class="fa fa-book"></i> Data Spesialis 
               <div class="pull-right" >
                  <div class="col-sm-12" align="pull-right">
                    <ul>
                      <a style="float: right;" href="<?php echo base_url('master/tambah_spesialis') ?>" class="btn btn-sm btn-primary">Tambah Spesialis &nbsp<i class="fa fa-plus"></i></a>
                    </ul>
                    </div>
                  </div>
          </h3>
              ...
              <table  class="table table-bordered table-striped" id="example1">
                ...
                foreach ($spesialis as $k) {
                  ...
                  <tr>
                   ...
                   <a href="<?php echo base_url().'master/edit_spesialis/'.$k->id; ?>" title="Edit Data">
