    ...
    <section class="sidebar">
      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
       <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="<?php echo base_url('admin/front') ?>">
        ...
        <li>
          <a href="<?php echo base_url('admin/daftar_pasien_front') ?>">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('pasien/d_pasien_front'); ?>"><i class="fa fa-circle-o"></i> Riwayat Rekam Medis</a></li>
